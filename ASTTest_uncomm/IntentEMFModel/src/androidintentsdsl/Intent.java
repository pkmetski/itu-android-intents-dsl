 ...
 *   <li>{@link androidintentsdsl.Intent#getDescription <em>Description</em>}</li>
 *   <li>{@link androidintentsdsl.Intent#getExceptionsThrown <em>Exceptions Thrown</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Intent extends EObject {
	 ...
	 * @see androidintentsdsl.AndroidintentsdslPackage#getIntent_Description()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link androidintentsdsl.Intent#getDescription <em>Description</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>Exceptions Thrown</b></em>' containment reference list.
	 * The list contents are of type {@link androidintentsdsl.Exception}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Exceptions Thrown</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Exceptions Thrown</em>' containment reference list.
	 * @see androidintentsdsl.AndroidintentsdslPackage#getIntent_ExceptionsThrown()
	 * @model containment="true" required="true"
	 * @generated
	 */
	EList<androidintentsdsl.Exception> getExceptionsThrown();
