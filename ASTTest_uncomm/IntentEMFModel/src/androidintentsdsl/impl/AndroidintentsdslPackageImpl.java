...
public class AndroidintentsdslPackageImpl extends EPackageImpl implements AndroidintentsdslPackage {
	 ...
	 * @generated
	 */
	public EReference getIntent_ExceptionsThrown() {
	...
	public void createPackageContents() {
		...
		createEReference(intentEClass, INTENT__EXCEPTIONS_THROWN);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getIntent_Description(), ecorePackage.getEString(), "description", null, 1, 1, Intent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getIntent_ExceptionsThrown(), this.getException(), null, "exceptionsThrown", null, 1, -1, Intent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
