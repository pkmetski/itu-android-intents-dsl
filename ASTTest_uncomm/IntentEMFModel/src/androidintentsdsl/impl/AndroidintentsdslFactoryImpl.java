...
public class AndroidintentsdslFactoryImpl extends EFactoryImpl implements AndroidintentsdslFactory {
	...
	public static AndroidintentsdslFactory init() {
		try {
			AndroidintentsdslFactory theAndroidintentsdslFactory = (AndroidintentsdslFactory)EPackage.Registry.INSTANCE.getEFactory("platform:/resource/IntentEMFModel/model/AndroidIntentsDsl.ecore"); 
