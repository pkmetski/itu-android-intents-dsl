...
public interface AndroidintentsdslPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://androidintentsdsl/1.0";
	...
	/**
	 * The feature id for the '<em><b>Exception Thrown</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int INTENT__EXCEPTION_THROWN = 2;
	 ...
	 * @ordered
	 */
	int INTENT__AVAILABLE_EXTRAS = 3;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link androidintentsdsl.Intent#getExceptionThrown <em>Exception Thrown</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Exception Thrown</em>'.
	 * @see androidintentsdsl.Intent#getExceptionThrown()
	 * @see #getIntent()
	 * @generated
	 */
	EReference getIntent_ExceptionThrown();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Exception Thrown</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference INTENT__EXCEPTION_THROWN = eINSTANCE.getIntent_ExceptionThrown();
